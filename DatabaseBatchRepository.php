...
class DatabaseBatchRepository implements PrunableBatchRepository
{
     ...
     *
     * @var \QuantaQuirk\Bus\BatchFactory
     */
    protected $factory;
     ...
     *
     * @param  \QuantaQuirk\Bus\BatchFactory  $factory
     ...
     *
     * @param  \QuantaQuirk\Bus\PendingBatch  $batch
     * @return \QuantaQuirk\Bus\Batch
     */
     ...
     * @param  string  $batchId
     * @param  string  $jobId
     * @return \QuantaQuirk\Bus\UpdatedBatchJobCounts
     */
